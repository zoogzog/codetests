...
public class TextTransformerCharacter implements TextTransformer
{
	...
	public TextTransformerCharacter ()
	{
	...
	public TextTransformerCharacter (char[] vocabulary)
	{
	...
	public void transform(String path, SequenceStorage storage) 
	{
		try
		{
			...
			storage.setSequenceDim(vocabulary.length);
